...
- **Update 2021.12.05**: Refactored for cleaner code by utilizing functional components and hooks. Refer to [this branch](https://github.com/shaiksajidhussain/tree/class-component) for the previous version implemented with class components.
